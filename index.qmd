...
fig1 ={
  ...
  `;
    ...
    nm.style.cssText = "font-size:8.5px;line-height:1.1;color:#fff;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;user-select:none;pointer-events:none;";
    btn.append(im, nm);
...
figure2grid = {
  ...
  const dsvg = d3.create("svg")
    .attr("viewBox", `0 0 ${DW} ${DH}`).attr("width", "18vw")
    .style("height", "auto")
...
figure3 = {
  ...
  chart_legend.style.cssText = "display:flex;gap:16px;flex-wrap:wrap;font-size:11.5px;color:#555;margin-top:4px;";
  let chart_legend_svg_file = await FileAttachment("assets/images/story/legend.svg").text();
